 ...
 */
 !(function () {
        ...
        xs = {
            ...
            getEncodeFunc: (e, t) => {
                ...
                return o.named && o.numeric
                    ? (e, t) =>
                          e.replace(t ? cs : us, (e) => (void 0 !== ps[e] ? ps[e] : void 0 !== n[e] ? n[e] : e.length > 1 ? "&#" + (1024 * (e.charCodeAt(0) - 55296) + (e.charCodeAt(1) - 56320) + 65536) + ";" : "&#" + e.charCodeAt(0) + ";"))
                    : o.named
                    ? t
                        ? (e, t) => ws(e, t, n)
                        : ws
    ...
    const dg = ["font", "text-decoration", "text-emphasis"],
        ...
        xp = (e) => wp(e, "Delete"),
        kp = (e) => sr(e) || ir(e),
        Sp = (e, t) => (vn(e, t) ? Ko(t, kp, ((e) => (t) => Bt(xn(t), e, bn))(e)) : M.none()),
        _p = (e, t = !0) => {
        ...
        Lp = (e, t, n, o) => {
            ...
            }
            {
                const e = Tp(n.startContainer, o),
                    ...
                    r = e.bind(((e) => (t) => fu(t, e).bind((e) => le(Rp(e)).map((e) => Ap(t, e))))(o)).bind(Pp(o)),
                    s = t.bind(((e) => (t) => fu(t, e).bind((e) => ie(Rp(e)).map((e) => Ap(e, t))))(o)).bind(Pp(o));
                    ...
                    a && zu(s) && !mu(e).length
                        ? ((e, t, n) => {
                              ...
                              if (l && i > 0 && i < l.length && d.test(l.charAt(i)) && d.test(l.charAt(i - 1))) {
                                  ...
                                  let s = o ? Ph(o) : null;
                                  (o && (null == s ? void 0 : s.data) === Bh) || ((c = e.getDoc()), (u = Lh(!0).dom), (o = c.importNode(u, !0)), (s = o.firstChild), a.insertNode(o), (i = 1)),
            ...
            var Ae = function (e) {
                ...
                Ie = function (e) {
                    ...
                    if (
                        ...
                        e.hasChildNodes() && !Le(e.firstElementChild) && (!Le(e.content) || !Le(e.content.firstElementChild)) && tv(/<[/\w]/g, e.innerHTML) && tv(/<[/\w]/g, e.textContent))
                    )
                        return Oe(e), !0;
                    ...
                    return e instanceof l && !Ae(e)
                        ...
                        ? (X && 3 === e.nodeType && ((t = e.textContent), (t = Jb(t, D, " ")), (t = Jb(t, P, " ")), e.textContent !== t && (Yb(n.removed, { element: e.cloneNode() }), (e.textContent = t))),
        ...
        Vv = (e, t, n) => {
            ...
            return (
                ...
                (!!/((java|vb)script|mhtml):/i.test(o) ||
                    (!e.allow_html_data_urls && (/^data:image\//i.test(o) ? ((e, t) => (C(e) ? !e : !C(t) || !j($v, t)))(e.allow_svg_data_urls, n) && /^data:image\/svg\+xml/i.test(o) : /^data:/i.test(o))))
            );
        };
    class qv {
        constructor(e, t = {}) {
                            ...
                            w &&
                                ...
                                ((e, n) => {
                                    ...
                                    if (t.isValidChild(e.name, n.toLowerCase())) {
                                        for (; i; ) {
                                            const t = i.next;
                                            3 === i.type || (1 === i.type && "p" !== i.name && !o[i.name] && !i.attr(Xv)) ? (l || ((l = new Zf(n, 1)), l.attr(r.forced_root_block_attrs), e.insert(l, i)), l.append(i)) : (d(l), (l = null)),
                                                (i = t);
                                        }
                                        d(l);
                                    }
    ...
    const Uy = (e) => !(!e || !e.ownerDocument) && vn(mn(e.ownerDocument), mn(e)),
        ...
        qy = "autoresize_on_init,content_editable_state,padd_empty_with_br,block_elements,boolean_attributes,editor_deselector,editor_selector,elements,file_browser_callback_types,filepicker_validator_handler,force_hex_style_colors,force_p_newlines,gecko_spellcheck,images_dataimg_filter,media_scripts,mode,move_caret_before_on_enter_elements,non_empty_elements,self_closing_elements,short_ended_elements,special,spellchecker_select_languages,spellchecker_whitelist,tab_focus,tabfocus_elements,table_responsive_width,text_block_elements,text_inline_elements,toolbar_drawer,types,validate,whitespace_elements,paste_enable_default_filters,paste_filter_drop,paste_word_valid_elements,paste_retain_style_properties,paste_convert_word_fake_lists".split(
            ","
        ),
                            ...
                            return !t && Eg(r)
                                ...
                                : ((e, t, n) =>
                                      ((e, t) => {
                                          ...
                                          ? ((e, t) => (y(t) ? M.none() : e && Io(t.nextSibling) ? M.some(dw.moveToElement(t.nextSibling)) : !e && Io(t.previousSibling) ? M.some(dw.moveToElement(t.previousSibling)) : M.none()))(
                                                t,
                                                n.getNode(!t)
                                            ).orThunk(() => cw(e, t, n))
                                          : cw(e, t, n).bind((t) =>
    ...
    const mx = (e, t, n, o, r, s) => {
        ...
        nS = (e, t, n, o, r) => {
            const s = Ta(e, ((e) => (t) => e.isBlock(t) || j(["BR", "IMG", "HR", "INPUT"], t.nodeName) || "false" === e.getContentEditable(t))(e));
                              ...
                              (r.onload = () => {
                                  ...
                                  (e.iframeHTML = ((e) => {
                                      ...
                                      const n = Gi(e),
                                          ...
                                          r = e.translate(td(e));
                                      return (
                                          Xi(e) && (t += '<meta http-equiv="Content-Security-Policy" content="' + Xi(e) + '" />'),
                ...
                "focus" !== e &&
                    ...
                    (n.removed ||
                        (t
                            ...
                            : n.initialized && n.delegates && (n.dom.unbind(ZR(n, e), e, n.delegates[e]), delete n.delegates[e])));
            },
