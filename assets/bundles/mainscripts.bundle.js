...
function CustomScrollbar() {
    $(".right_menu .slim_scroll").slimscroll({ height: "calc(100vh - 30px)", color: "rgba(0,0,0,0.1)", position: "right", size: "2px", alwaysVisible: !1, borderRadius: "3px", railBorderRadius: "0" }),
        $(".cwidget-scroll").slimscroll({ height: "306px", color: "rgba(0,0,0,0.4)", size: "2px", alwaysVisible: !1, borderRadius: "3px", railBorderRadius: "2px" }),
        $(".right-sidebar .slim_scroll").slimscroll({ height: "calc(100vh - 100px)", color: "rgba(0,0,0,0.4)", size: "2px", alwaysVisible: !1, borderRadius: "3px", railBorderRadius: "0" });
}
function CustomPageJS() {
    $(".boxs-close").on("click", function () {
        ...
        $(".minileftbar .perananapp-btn").on("click", function () {
            $(".right_menu .peranan-app").toggleClass("open stretchRight").siblings().removeClass("open stretchRight"), $(".right_menu .peranan-app").hasClass("open") ? $(".overlay").fadeIn() : $(".overlay").fadeOut();
        }),
...
($.AdminAlpino.browser = {
    ...
    $(function () {
        ...
        var e = document.querySelector('.theme-switch input[type="checkbox"]'),
            t = document.querySelector('.theme-high-contrast input[type="checkbox"]'),
            n = localStorage.getItem("theme");
        n && (document.documentElement.setAttribute("data-theme", n), "dark" === n && (e.checked = !0), "high-contrast" === n && ((t.checked = !0), (e.checked = !1))),
            e.addEventListener(
                "change",
                function (e) {
                    e.target.checked
...
!(function () {
    ...
    (a.async = !0), (a.src = "https://embed.tawk.to/5c6d4867f324050cfe342c69/default"), (a.charset = "UTF-8"), a.setAttribute("crossorigin", "*"), b.parentNode.insertBefore(a, b);
})(),
    $(function () {
        "use strict";
        function a() {
