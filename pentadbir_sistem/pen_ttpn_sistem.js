$(function () {
    ...
    saveLog("View Page: Konfigurasi Sistem", sessionStorage.browser);
    var settings = {
    ...
    $.ajax(settings).done(function (response) {
        $("#leftsidebar").load('../aside/aside_pen_ttpn_sistem.html');
        ...
        swal({
            ...
            $.ajax(settings).done(function (response) {
                ...
                if (!result.success) {
                    ...
                    saveLog("Update Data Konfigurasi Sistem.",window.sessionStorage.browser);
                    window.location.reload();  
                }
            });
