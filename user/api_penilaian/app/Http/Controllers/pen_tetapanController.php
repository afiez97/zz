...
class pen_tetapanController extends Controller
{
    ...
    public function show(Request $request)  {
        ...
        $pen_tetapan = pen_tetapan::where('id_tetapan',$id)->first();
    ...
    public function list()  {
        $pen_tetapan = pen_tetapan::where('statusrekod','1') -> first();
    ...
    public function update(Request $request)    {
        ...
        // $pen_tetapan = pen_tetapan::find($id); 

        $pen_tetapan = pen_tetapan::where('id_tetapan',$id)  -> update([
            'nama_sistem' => $nama_sistem,
            'versi_sistem' => $versi_sistem,
            'pelepasan_sistem' => $pelepasan_sistem,
            'status_sistem' => $status_sistem,
